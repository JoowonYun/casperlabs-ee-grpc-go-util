...
type Deploy_Arg_Value_OptionalValue struct {
	OptionalValue *Deploy_Arg_Value `protobuf:"bytes,1,opt,name=optional_value,json=optionalValue,proto3,oneof" json:"optional_value,omitempty"`
}
...
var fileDescriptor_1ef60ffad3b483db = []byte{
	...
	,
}
