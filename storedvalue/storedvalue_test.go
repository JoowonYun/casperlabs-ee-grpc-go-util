...
func TestStoredValueAbi(t *testing.T) {
	bytes, err := hex.DecodeString("")
	assert.NoError(t, err)

	var storedValue StoredValue
	storedValue, err, length := storedValue.FromBytes(bytes)

	assert.Equal(t, TYPE_ACCOUNT, storedValue.Type)
